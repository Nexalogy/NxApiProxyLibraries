...
{        
   ...
   public static function testHeatMap($projectId, $options=array())
   {
      $url = '/reports/testHeatMap';
   ...
   public static function testTsaData($projectId, $reportName, $type, $options=array())
   {
      $url = '/reports/testTsaData';
   ...
   public static function sdaAsync($projectId, $reportName, $type, $options=array())
   {
      $url = '/reports/sdaAsync';
   ...
   public static function tsaAsync($projectId, $reportName, $type, $options=array())
   {
      $url = '/reports/tsaAsync';
