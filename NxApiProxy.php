...
{        
   ...
   public static function create($projectId, $name, $options=array('intervalEvaluated'=>'', 'scheduleCrontab'=>'', 'scheduleActive'=>'', 'scheduleFilterId'=>'', 'scheduleStartOn'=>'', 'scheduleRecipientList'=>'', 'reportList'=>''))
   {
   ...
   public static function modify($projectId, $id, $name, $options=array('intervalEvaluated'=>'', 'scheduleCrontab'=>'', 'scheduleActive'=>'', 'scheduleFilterId'=>'', 'scheduleStartOn'=>'', 'scheduleRecipientList'=>'', 'reportList'=>''))
   {
   ...
   public static function getSnaphotList($projectId, $id, $options=array())
   {
      $url = '/automatedReport/getSnaphotList';
